...
// when synchronised factorial is counted correctly and also when we remove it, because every thread works on its own resource, in the second ex every thread had the same resource therefore the results returned made no sense.
